...
const AddAsset = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      setError(err.message || 'Failed to register the new asset. Check if the serial number is unique.');
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 text-xs sm:text-sm mt-1">
            Register a new device, component, or system into the asset tracking database.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-end gap-4 pt-4 border-t border-gray-200">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-purple-650 hover:bg-purple-750 text-gray-700 font-semibold text-xs rounded-xl shadow-md shadow-purple-650/10 transition-all duration-200 hover:scale-[1.01] active:scale-[0.99] disabled:opacity-50 disabled:pointer-events-none"
              >
                {isLoading ? (
